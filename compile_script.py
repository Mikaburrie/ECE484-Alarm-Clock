...
files_to_compile = ['alarm', 'lib/HD44780', 'IRremote/irremote', 'IRremote/commonTimer']
file_to_compile = 'alarm'
if len(sys.argv) == 2:
    com_port = 'com4'
else:
	com_port = sys.argv[2]
...
if level_of_compilation >= 4:
    cmd = path_win_avr + 'avrdude -F -V -c arduino -p ATMEGA328P -P'+com_port+' -b 115200 -U flash:w:'+file_to_compile+'.hex'
    run_command(cmd)